...
var (
	...
	ErrIdempotentWriteNotSupported        = newWoodpeckerError("idempotent write not supported for local storage mode", 1406, false)
	ErrIdempotentWriteRecoveryFailed      = newWoodpeckerError("idempotent write recovery failed", 1407, true)
	ErrIdempotentWriteSnapshotSaveFailed  = newWoodpeckerError("idempotent write snapshot save failed", 1408, true)
