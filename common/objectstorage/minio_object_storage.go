...
func (minioObjectStorage *MinioObjectStorage) GetObject(ctx context.Context, bucketName, objectName string, offset int64, size int64) (minioHandler.FileReader, error) {
	...
	object, err := minioObjectStorage.minioHandler.GetObject(ctx, bucketName, objectName, opts)
	if err != nil {
		return nil, err
	}
...
func (minioObjectStorage *MinioObjectStorage) PutObject(ctx context.Context, bucketName, objectName string, reader io.Reader, objectSize int64) error {
	_, err := minioObjectStorage.minioHandler.PutObject(ctx, bucketName, objectName, reader, objectSize, minio.PutObjectOptions{})
	return err
}

func (minioObjectStorage *MinioObjectStorage) PutObjectIfNoneMatch(ctx context.Context, bucketName, objectName string, reader io.Reader, objectSize int64) error {
	_, err := minioObjectStorage.minioHandler.PutObjectIfNoneMatch(ctx, bucketName, objectName, reader, objectSize)
	return err
}

func (minioObjectStorage *MinioObjectStorage) PutFencedObject(ctx context.Context, bucketName, objectName string) error {
	_, err := minioObjectStorage.minioHandler.PutFencedObject(ctx, bucketName, objectName)
	return err
}

func (minioObjectStorage *MinioObjectStorage) StatObject(ctx context.Context, bucketName, objectName string) (int64, bool, error) {
	info, err := minioObjectStorage.minioHandler.StatObject(ctx, bucketName, objectName, minio.StatObjectOptions{})
	if err != nil {
		return -1, false, err
	}
...
func (minioObjectStorage *MinioObjectStorage) RemoveObject(ctx context.Context, bucketName, objectName string) error {
	err := minioObjectStorage.minioHandler.RemoveObject(ctx, bucketName, objectName, minio.RemoveObjectOptions{})
	return err
}
