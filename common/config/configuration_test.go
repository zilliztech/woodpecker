...
func TestNewConfiguration(t *testing.T) {
	...
	assert.Equal(t, 64, config.Woodpecker.Logstore.SegmentSyncPolicy.MaxFlushThreads)
	assert.Equal(t, int64(4000000), config.Woodpecker.Logstore.SegmentCompactionPolicy.MaxBytes)
