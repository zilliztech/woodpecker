...
func TestNewConfiguration(t *testing.T) {
	...
	assert.Equal(t, int64(128000000), config.Woodpecker.Client.SegmentRollingPolicy.MaxSize)
	...
	assert.Equal(t, int64(32000000), config.Woodpecker.Logstore.LogFileSyncPolicy.MaxBytes)
	...
	assert.Equal(t, int64(8000000), config.Woodpecker.Logstore.LogFileSyncPolicy.MaxFlushSize)
	assert.Equal(t, 4, config.Woodpecker.Logstore.LogFileSyncPolicy.MaxFlushThreads)
	assert.Equal(t, int64(8000000), config.Woodpecker.Logstore.LogFileCompactionPolicy.MaxBytes)
	assert.Equal(t, int64(128000000), config.Woodpecker.Logstore.FragmentManager.MaxBytes)
	assert.Equal(t, 1000, config.Woodpecker.Logstore.FragmentManager.MaxInterval)
	...
	assert.Equal(t, 2000, defaultConfig.Woodpecker.Logstore.LogFileSyncPolicy.MaxEntries)
	assert.Equal(t, int64(100000000), defaultConfig.Woodpecker.Logstore.LogFileSyncPolicy.MaxBytes)
	...
	assert.Equal(t, int64(16000000), defaultConfig.Woodpecker.Logstore.LogFileSyncPolicy.MaxFlushSize)
	assert.Equal(t, 8, defaultConfig.Woodpecker.Logstore.LogFileSyncPolicy.MaxFlushThreads)
	assert.Equal(t, int64(32000000), defaultConfig.Woodpecker.Logstore.LogFileCompactionPolicy.MaxBytes)
	assert.Equal(t, int64(128000000), defaultConfig.Woodpecker.Logstore.FragmentManager.MaxBytes)
	assert.Equal(t, 2000, defaultConfig.Woodpecker.Logstore.FragmentManager.MaxInterval)
