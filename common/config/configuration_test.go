...
func TestNewConfiguration(t *testing.T) {
	...
	assert.Equal(t, int64(128000000), config.Woodpecker.Logstore.SegmentSyncPolicy.MaxBytes)
	...
	assert.Equal(t, int64(4000000), config.Woodpecker.Logstore.SegmentSyncPolicy.MaxFlushSize)
