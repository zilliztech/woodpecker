...
func TestNewConfiguration(t *testing.T) {
	...
	assert.Equal(t, int64(32000000), config.Woodpecker.Logstore.SegmentSyncPolicy.MaxBytes)
	...
	assert.Equal(t, int64(8000000), config.Woodpecker.Logstore.SegmentSyncPolicy.MaxFlushSize)
	assert.Equal(t, 4, config.Woodpecker.Logstore.SegmentSyncPolicy.MaxFlushThreads)
	assert.Equal(t, int64(8000000), config.Woodpecker.Logstore.SegmentCompactionPolicy.MaxBytes)
