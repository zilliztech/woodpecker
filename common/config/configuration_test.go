...
func TestNewConfiguration(t *testing.T) {
	...
	assert.Equal(t, int64(2000000000), config.Woodpecker.Client.SegmentRollingPolicy.MaxSize)
	...
	assert.Equal(t, int64(64000000), config.Woodpecker.Logstore.LogFileSyncPolicy.MaxBytes)
	...
	assert.Equal(t, int64(1000000000), config.Woodpecker.Logstore.FragmentManager.MaxBytes)
	...
	assert.Equal(t, int64(256000000), defaultConfig.Woodpecker.Logstore.FragmentManager.MaxBytes)
