...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Options:"
            echo "  -run PATTERN        Run tests matching pattern (e.g., TestMonitor_MetricsVerification)"
...
if [ "$CLEANUP_ONLY" = true ]; then
    echo "Cleaning up monitor test resources..."
...
for container in etcd minio woodpecker-node1 woodpecker-node2 woodpecker-node3 woodpecker-node4 prometheus grafana; do
