...
type SegmentCompactedNotifyState int32

const (
	SegmentCompactedNotifyState_NOTIFY_IN_PROGRESS SegmentCompactedNotifyState = 0
	SegmentCompactedNotifyState_NOTIFY_COMPLETED   SegmentCompactedNotifyState = 1
	...
	SegmentCompactedNotifyState_NOTIFY_PENDING_MANUAL SegmentCompactedNotifyState = 2
	...
	SegmentCompactedNotifyState_NOTIFY_OPERATOR_CONFIRMED SegmentCompactedNotifyState = 3
)

// Enum value maps for SegmentCompactedNotifyState.
var (
	SegmentCompactedNotifyState_name = map[int32]string{
		0: "NOTIFY_IN_PROGRESS",
		1: "NOTIFY_COMPLETED",
		2: "NOTIFY_PENDING_MANUAL",
		3: "NOTIFY_OPERATOR_CONFIRMED",
	}
	SegmentCompactedNotifyState_value = map[string]int32{
...
func (x SegmentCompactedNotifyState) Enum() *SegmentCompactedNotifyState {
	p := new(SegmentCompactedNotifyState)
	*p = x
	return p
}

func (x SegmentCompactedNotifyState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SegmentCompactedNotifyState) Descriptor() protoreflect.EnumDescriptor {
	return file_meta_proto_enumTypes[2].Descriptor()
}

func (SegmentCompactedNotifyState) Type() protoreflect.EnumType {
	return &file_meta_proto_enumTypes[2]
}

func (x SegmentCompactedNotifyState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SegmentCompactedNotifyState.Descriptor instead.
func (SegmentCompactedNotifyState) EnumDescriptor() ([]byte, []int) {
...
type QuorumInfo struct {
	...
	Replicas      []*QuorumNode          `protobuf:"bytes,6,rep,name=replicas,proto3" json:"replicas,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *QuorumInfo) GetReplicas() []*QuorumNode {
	if x != nil {
		return x.Replicas
	}
	return nil
...
func (x *QuorumNode) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QuorumNode) ProtoMessage() {}

func (x *QuorumNode) ProtoReflect() protoreflect.Message {
	mi := &file_meta_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QuorumNode.ProtoReflect.Descriptor instead.
func (*QuorumNode) Descriptor() ([]byte, []int) {
	return file_meta_proto_rawDescGZIP(), []int{4}
}

// Deprecated: Marked as deprecated in meta.proto.
func (x *QuorumNode) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *QuorumNode) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *QuorumNode) GetClusterName() string {
	if x != nil {
...
func (x *QuorumNode) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *QuorumNode) GetAz() string {
	if x != nil {
		return x.Az
	}
	return ""
...
func (x *QuorumNode) GetResourceGroup() string {
	if x != nil {
...
func (x *QuorumNode) GetTags() map[string]string {
	if x != nil {
		return x.Tags
	}
	return nil
...
type SegmentCompactedNotifyStatus struct {
	state              protoimpl.MessageState      `protogen:"open.v1"`
	LogId              int64                       `protobuf:"varint,1,opt,name=log_id,json=logId,proto3" json:"log_id,omitempty"`
	SegmentId          int64                       `protobuf:"varint,2,opt,name=segment_id,json=segmentId,proto3" json:"segment_id,omitempty"`
	State              SegmentCompactedNotifyState `protobuf:"varint,3,opt,name=state,proto3,enum=woodpecker.proto.meta.SegmentCompactedNotifyState" json:"state,omitempty"`
	StartTime          uint64                      `protobuf:"varint,4,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`                                                                                                        // Unix timestamp in milliseconds when distribution started
	LastUpdateTime     uint64                      `protobuf:"varint,5,opt,name=last_update_time,json=lastUpdateTime,proto3" json:"last_update_time,omitempty"`                                                                                       // Unix timestamp in milliseconds of the last update
	QuorumNotifyStatus map[string]bool             `protobuf:"bytes,6,rep,name=quorum_notify_status,json=quorumNotifyStatus,proto3" json:"quorum_notify_status,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // Map of node address to "mark acked"
	ErrorMessage       string                      `protobuf:"bytes,7,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`                                                                                                // Why the record went PENDING_MANUAL
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *SegmentCompactedNotifyStatus) Reset() {
	*x = SegmentCompactedNotifyStatus{}
	mi := &file_meta_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SegmentCompactedNotifyStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SegmentCompactedNotifyStatus) ProtoMessage() {}

func (x *SegmentCompactedNotifyStatus) ProtoReflect() protoreflect.Message {
	mi := &file_meta_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SegmentCompactedNotifyStatus.ProtoReflect.Descriptor instead.
func (*SegmentCompactedNotifyStatus) Descriptor() ([]byte, []int) {
	return file_meta_proto_rawDescGZIP(), []int{7}
}

func (x *SegmentCompactedNotifyStatus) GetLogId() int64 {
	if x != nil {
		return x.LogId
	}
	return 0
...
func (x *SegmentCompactedNotifyStatus) GetSegmentId() int64 {
	if x != nil {
		return x.SegmentId
	}
	return 0
...
func (x *SegmentCompactedNotifyStatus) GetState() SegmentCompactedNotifyState {
	if x != nil {
		return x.State
	}
	return SegmentCompactedNotifyState_NOTIFY_IN_PROGRESS
}

func (x *SegmentCompactedNotifyStatus) GetStartTime() uint64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *SegmentCompactedNotifyStatus) GetLastUpdateTime() uint64 {
	if x != nil {
		return x.LastUpdateTime
	}
	return 0
...
func (x *SegmentCompactedNotifyStatus) GetQuorumNotifyStatus() map[string]bool {
	if x != nil {
		return x.QuorumNotifyStatus
	}
	return nil
}

func (x *SegmentCompactedNotifyStatus) GetErrorMessage() string {
	if x != nil {
		return x.ErrorMessage
	}
	return ""
...
var file_meta_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x22, 0xa1, 0x01, 0x0a, 0x0a, 0x51, 0x75, 0x6f, 0x72, 0x75, 0x6d, 0x49, 0x6e, 0x66,
	...
	,
	...
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x61, 0x7a, 0x12, 0x25, 0x0a, 0x0e, 0x72, 0x65, 0x73,
	...
	0x6f, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x51, 0x75, 0x6f, 0x72, 0x75, 0x6d, 0x4e, 0x6f, 0x64,
	...
	,
	...
	0x32, 0x2a, 0x2e, 0x77, 0x6f, 0x6f, 0x64, 0x70, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74,
	0x43, 0x6c, 0x65, 0x61, 0x6e, 0x75, 0x70, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74,
	...
	,
	...
	0x72, 0x72, 0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x46, 0x0a, 0x18, 0x51,
	...
	0x02, 0x38, 0x01, 0x22, 0xd2, 0x03, 0x0a, 0x1c, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x43,
	0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x65, 0x64, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x12, 0x15, 0x0a, 0x06, 0x6c, 0x6f, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x01,
	...
	0x09, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x48, 0x0a, 0x05, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x32, 0x2e, 0x77, 0x6f, 0x6f, 0x64,
	0x70, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x6d, 0x65, 0x74,
	0x61, 0x2e, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74,
	0x65, 0x64, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73,
	...
	,
...
var file_meta_proto_goTypes = []any{
	...
	(SegmentCompactedNotifyState)(0),     // 2: woodpecker.proto.meta.SegmentCompactedNotifyState
	(*LogMeta)(nil),                      // 3: woodpecker.proto.meta.LogMeta
	(*SegmentMetadata)(nil),              // 4: woodpecker.proto.meta.SegmentMetadata
	(*Version)(nil),                      // 5: woodpecker.proto.meta.Version
	(*QuorumInfo)(nil),                   // 6: woodpecker.proto.meta.QuorumInfo
	(*QuorumNode)(nil),                   // 7: woodpecker.proto.meta.QuorumNode
	(*ReaderTempInfo)(nil),               // 8: woodpecker.proto.meta.ReaderTempInfo
	(*SegmentCleanupStatus)(nil),         // 9: woodpecker.proto.meta.SegmentCleanupStatus
	(*SegmentCompactedNotifyStatus)(nil), // 10: woodpecker.proto.meta.SegmentCompactedNotifyStatus
	nil,                                  // 11: woodpecker.proto.meta.QuorumNode.TagsEntry
	nil,                                  // 12: woodpecker.proto.meta.SegmentCleanupStatus.QuorumCleanupStatusEntry
	nil,                                  // 13: woodpecker.proto.meta.SegmentCompactedNotifyStatus.QuorumNotifyStatusEntry
}
var file_meta_proto_depIdxs = []int32{
	...
	6,  // 1: woodpecker.proto.meta.SegmentMetadata.quorum:type_name -> woodpecker.proto.meta.QuorumInfo
	7,  // 2: woodpecker.proto.meta.QuorumInfo.replicas:type_name -> woodpecker.proto.meta.QuorumNode
	11, // 3: woodpecker.proto.meta.QuorumNode.tags:type_name -> woodpecker.proto.meta.QuorumNode.TagsEntry
	1,  // 4: woodpecker.proto.meta.SegmentCleanupStatus.state:type_name -> woodpecker.proto.meta.SegmentCleanupState
	12, // 5: woodpecker.proto.meta.SegmentCleanupStatus.quorum_cleanup_status:type_name -> woodpecker.proto.meta.SegmentCleanupStatus.QuorumCleanupStatusEntry
	2,  // 6: woodpecker.proto.meta.SegmentCompactedNotifyStatus.state:type_name -> woodpecker.proto.meta.SegmentCompactedNotifyState
	13, // 7: woodpecker.proto.meta.SegmentCompactedNotifyStatus.quorum_notify_status:type_name -> woodpecker.proto.meta.SegmentCompactedNotifyStatus.QuorumNotifyStatusEntry
