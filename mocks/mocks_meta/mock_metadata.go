...
// DeleteSegmentMetadata provides a mock function with given fields: ctx, logName, segmentId
func (_m *MetadataProvider) DeleteSegmentMetadata(ctx context.Context, logName string, segmentId int64) error {
...
//   - logName string
//   - segmentId int64
func (_e *MetadataProvider_Expecter) DeleteSegmentMetadata(ctx interface{}, logName interface{}, segmentId interface{}) *MetadataProvider_DeleteSegmentMetadata_Call {
	return &MetadataProvider_DeleteSegmentMetadata_Call{Call: _e.mock.On("DeleteSegmentMetadata", ctx, logName, segmentId)}
}

func (_c *MetadataProvider_DeleteSegmentMetadata_Call) Run(run func(ctx context.Context, logName string, segmentId int64)) *MetadataProvider_DeleteSegmentMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(int64))
	})
	return _c
...
// StoreSegmentMetadata provides a mock function with given fields: ctx, logName, segmentMeta
func (_m *MetadataProvider) StoreSegmentMetadata(ctx context.Context, logName string, segmentMeta *meta.SegmentMeta) error {
	ret := _m.Called(ctx, logName, segmentMeta)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *meta.SegmentMeta) error); ok {
		r0 = rf(ctx, logName, segmentMeta)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MetadataProvider_Expecter) StoreSegmentMetadata(ctx interface{}, logName interface{}, segmentMeta interface{}) *MetadataProvider_StoreSegmentMetadata_Call {
	return &MetadataProvider_StoreSegmentMetadata_Call{Call: _e.mock.On("StoreSegmentMetadata", ctx, logName, segmentMeta)}
}

func (_c *MetadataProvider_StoreSegmentMetadata_Call) Run(run func(ctx context.Context, logName string, segmentMeta *meta.SegmentMeta)) *MetadataProvider_StoreSegmentMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*meta.SegmentMeta))
	})
	return _c
}
...
func (_c *MetadataProvider_StoreSegmentMetadata_Call) RunAndReturn(run func(context.Context, string, *meta.SegmentMeta) error) *MetadataProvider_StoreSegmentMetadata_Call {
	_c.Call.Return(run)
	return _c
}
...
// UpdateSegmentMetadata provides a mock function with given fields: ctx, logName, segmentMeta
func (_m *MetadataProvider) UpdateSegmentMetadata(ctx context.Context, logName string, segmentMeta *meta.SegmentMeta) error {
	ret := _m.Called(ctx, logName, segmentMeta)
...
//   - logName string
//   - segmentMeta *meta.SegmentMeta
func (_e *MetadataProvider_Expecter) UpdateSegmentMetadata(ctx interface{}, logName interface{}, segmentMeta interface{}) *MetadataProvider_UpdateSegmentMetadata_Call {
	return &MetadataProvider_UpdateSegmentMetadata_Call{Call: _e.mock.On("UpdateSegmentMetadata", ctx, logName, segmentMeta)}
}

func (_c *MetadataProvider_UpdateSegmentMetadata_Call) Run(run func(ctx context.Context, logName string, segmentMeta *meta.SegmentMeta)) *MetadataProvider_UpdateSegmentMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*meta.SegmentMeta))
	})
	return _c
...
func (_c *MetadataProvider_UpdateSegmentMetadata_Call) RunAndReturn(run func(context.Context, string, *meta.SegmentMeta) error) *MetadataProvider_UpdateSegmentMetadata_Call {
	_c.Call.Return(run)
	return _c
}
