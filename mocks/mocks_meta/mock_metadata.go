...
// CheckSegmentExists provides a mock function with given fields: ctx, name, segmentId
func (_m *MetadataProvider) CheckSegmentExists(ctx context.Context, name string, segmentId int64) (bool, error) {
	ret := _m.Called(ctx, name, segmentId)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) (bool, error)); ok {
		return rf(ctx, name, segmentId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) bool); ok {
		r0 = rf(ctx, name, segmentId)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, int64) error); ok {
		r1 = rf(ctx, name, segmentId)
	} else {
		r1 = ret.Error(1)
	}
...
//   - name string
//   - segmentId int64
func (_e *MetadataProvider_Expecter) CheckSegmentExists(ctx interface{}, name interface{}, segmentId interface{}) *MetadataProvider_CheckSegmentExists_Call {
	return &MetadataProvider_CheckSegmentExists_Call{Call: _e.mock.On("CheckSegmentExists", ctx, name, segmentId)}
}

func (_c *MetadataProvider_CheckSegmentExists_Call) Run(run func(ctx context.Context, name string, segmentId int64)) *MetadataProvider_CheckSegmentExists_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
//   - segmentId int64
//   - entryId int64
func (_e *MetadataProvider_Expecter) CreateReaderTempInfo(ctx interface{}, readerName interface{}, logId interface{}, segmentId interface{}, entryId interface{}) *MetadataProvider_CreateReaderTempInfo_Call {
	return &MetadataProvider_CreateReaderTempInfo_Call{Call: _e.mock.On("CreateReaderTempInfo", ctx, readerName, logId, segmentId, entryId)}
}

func (_c *MetadataProvider_CreateReaderTempInfo_Call) Run(run func(ctx context.Context, readerName string, logId int64, segmentId int64, entryId int64)) *MetadataProvider_CreateReaderTempInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
type MetadataProvider_CreateSegmentCompactedNotifyStatus_Call struct {
	*mock.Call
}

// CreateSegmentCompactedNotifyStatus is a helper method to define mock.On call
//   - ctx context.Context
//   - status *proto.SegmentCompactedNotifyStatus
func (_e *MetadataProvider_Expecter) CreateSegmentCompactedNotifyStatus(ctx interface{}, status interface{}) *MetadataProvider_CreateSegmentCompactedNotifyStatus_Call {
	return &MetadataProvider_CreateSegmentCompactedNotifyStatus_Call{Call: _e.mock.On("CreateSegmentCompactedNotifyStatus", ctx, status)}
}

func (_c *MetadataProvider_CreateSegmentCompactedNotifyStatus_Call) Run(run func(ctx context.Context, status *proto.SegmentCompactedNotifyStatus)) *MetadataProvider_CreateSegmentCompactedNotifyStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// DeleteLogMetadata provides a mock function with given fields: ctx, logName, force
func (_m *MetadataProvider) DeleteLogMetadata(ctx context.Context, logName string, force bool) error {
	ret := _m.Called(ctx, logName, force)

	if len(ret) == 0 {
		panic("no return value specified for DeleteLogMetadata")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) error); ok {
		r0 = rf(ctx, logName, force)
	} else {
		r0 = ret.Error(0)
	}
...
// MetadataProvider_DeleteLogMetadata_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteLogMetadata'
type MetadataProvider_DeleteLogMetadata_Call struct {
	*mock.Call
}

// DeleteLogMetadata is a helper method to define mock.On call
//   - ctx context.Context
//   - logName string
//   - force bool
func (_e *MetadataProvider_Expecter) DeleteLogMetadata(ctx interface{}, logName interface{}, force interface{}) *MetadataProvider_DeleteLogMetadata_Call {
	return &MetadataProvider_DeleteLogMetadata_Call{Call: _e.mock.On("DeleteLogMetadata", ctx, logName, force)}
}

func (_c *MetadataProvider_DeleteLogMetadata_Call) Run(run func(ctx context.Context, logName string, force bool)) *MetadataProvider_DeleteLogMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MetadataProvider_DeleteLogMetadata_Call) Return(_a0 error) *MetadataProvider_DeleteLogMetadata_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MetadataProvider_DeleteLogMetadata_Call) RunAndReturn(run func(context.Context, string, bool) error) *MetadataProvider_DeleteLogMetadata_Call {
	_c.Call.Return(run)
	return _c
}
...
// DeleteSegmentCompactedNotifyStatus provides a mock function with given fields: ctx, logId, segmentId
func (_m *MetadataProvider) DeleteSegmentCompactedNotifyStatus(ctx context.Context, logId int64, segmentId int64) error {
	ret := _m.Called(ctx, logId, segmentId)

	if len(ret) == 0 {
		panic("no return value specified for DeleteSegmentCompactedNotifyStatus")
	}
...
// MetadataProvider_DeleteSegmentCompactedNotifyStatus_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteSegmentCompactedNotifyStatus'
type MetadataProvider_DeleteSegmentCompactedNotifyStatus_Call struct {
	*mock.Call
}

// DeleteSegmentCompactedNotifyStatus is a helper method to define mock.On call
//   - ctx context.Context
//   - logId int64
//   - segmentId int64
func (_e *MetadataProvider_Expecter) DeleteSegmentCompactedNotifyStatus(ctx interface{}, logId interface{}, segmentId interface{}) *MetadataProvider_DeleteSegmentCompactedNotifyStatus_Call {
	return &MetadataProvider_DeleteSegmentCompactedNotifyStatus_Call{Call: _e.mock.On("DeleteSegmentCompactedNotifyStatus", ctx, logId, segmentId)}
}

func (_c *MetadataProvider_DeleteSegmentCompactedNotifyStatus_Call) Run(run func(ctx context.Context, logId int64, segmentId int64)) *MetadataProvider_DeleteSegmentCompactedNotifyStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(int64))
	})
	return _c
...
func (_c *MetadataProvider_DeleteSegmentCompactedNotifyStatus_Call) Return(_a0 error) *MetadataProvider_DeleteSegmentCompactedNotifyStatus_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MetadataProvider_DeleteSegmentCompactedNotifyStatus_Call) RunAndReturn(run func(context.Context, int64, int64) error) *MetadataProvider_DeleteSegmentCompactedNotifyStatus_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteSegmentMetadata provides a mock function with given fields: ctx, logName, logId, segmentId, oldState
func (_m *MetadataProvider) DeleteSegmentMetadata(ctx context.Context, logName string, logId int64, segmentId int64, oldState proto.SegmentState) error {
	ret := _m.Called(ctx, logName, logId, segmentId, oldState)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int64, int64, proto.SegmentState) error); ok {
		r0 = rf(ctx, logName, logId, segmentId, oldState)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MetadataProvider_Expecter) DeleteSegmentMetadata(ctx interface{}, logName interface{}, logId interface{}, segmentId interface{}, oldState interface{}) *MetadataProvider_DeleteSegmentMetadata_Call {
	return &MetadataProvider_DeleteSegmentMetadata_Call{Call: _e.mock.On("DeleteSegmentMetadata", ctx, logName, logId, segmentId, oldState)}
}

func (_c *MetadataProvider_DeleteSegmentMetadata_Call) Run(run func(ctx context.Context, logName string, logId int64, segmentId int64, oldState proto.SegmentState)) *MetadataProvider_DeleteSegmentMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(int64), args[3].(int64), args[4].(proto.SegmentState))
	})
	return _c
}
...
func (_c *MetadataProvider_DeleteSegmentMetadata_Call) RunAndReturn(run func(context.Context, string, int64, int64, proto.SegmentState) error) *MetadataProvider_DeleteSegmentMetadata_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetAllSegmentMetadata provides a mock function with given fields: ctx, logName
func (_m *MetadataProvider) GetAllSegmentMetadata(ctx context.Context, logName string) (map[int64]*meta.SegmentMeta, error) {
	ret := _m.Called(ctx, logName)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (map[int64]*meta.SegmentMeta, error)); ok {
		return rf(ctx, logName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) map[int64]*meta.SegmentMeta); ok {
		r0 = rf(ctx, logName)
	} else {
		if ret.Get(0) != nil {
...
//   - ctx context.Context
//   - logName string
func (_e *MetadataProvider_Expecter) GetAllSegmentMetadata(ctx interface{}, logName interface{}) *MetadataProvider_GetAllSegmentMetadata_Call {
	return &MetadataProvider_GetAllSegmentMetadata_Call{Call: _e.mock.On("GetAllSegmentMetadata", ctx, logName)}
}

func (_c *MetadataProvider_GetAllSegmentMetadata_Call) Run(run func(ctx context.Context, logName string)) *MetadataProvider_GetAllSegmentMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MetadataProvider_GetAllSegmentMetadata_Call) Return(_a0 map[int64]*meta.SegmentMeta, _a1 error) *MetadataProvider_GetAllSegmentMetadata_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *MetadataProvider) GetLogMeta(ctx context.Context, logName string) (*meta.LogMeta, error) {
	ret := _m.Called(ctx, logName)
	...
	var r0 *meta.LogMeta
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*meta.LogMeta, error)); ok {
		return rf(ctx, logName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *meta.LogMeta); ok {
		r0 = rf(ctx, logName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*meta.LogMeta)
		}
	}
...
func (_c *MetadataProvider_GetLogMeta_Call) Return(_a0 *meta.LogMeta, _a1 error) *MetadataProvider_GetLogMeta_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MetadataProvider_GetLogMeta_Call) RunAndReturn(run func(context.Context, string) (*meta.LogMeta, error)) *MetadataProvider_GetLogMeta_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - ctx context.Context
//   - quorumId int64
func (_e *MetadataProvider_Expecter) GetQuorumInfo(ctx interface{}, quorumId interface{}) *MetadataProvider_GetQuorumInfo_Call {
	return &MetadataProvider_GetQuorumInfo_Call{Call: _e.mock.On("GetQuorumInfo", ctx, quorumId)}
}

func (_c *MetadataProvider_GetQuorumInfo_Call) Run(run func(ctx context.Context, quorumId int64)) *MetadataProvider_GetQuorumInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
func (_m *MetadataProvider) GetSegmentCompactedNotifyStatus(ctx context.Context, logId int64, segmentId int64) (*proto.SegmentCompactedNotifyStatus, int64, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetSegmentCompactedNotifyStatus")
	}
	...
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64) *proto.SegmentCompactedNotifyStatus); ok {
		...
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*proto.SegmentCompactedNotifyStatus)
		}
	}
...
type MetadataProvider_GetSegmentCompactedNotifyStatus_Call struct {
	*mock.Call
}

// GetSegmentCompactedNotifyStatus is a helper method to define mock.On call
//   - ctx context.Context
//   - logId int64
//   - segmentId int64
func (_e *MetadataProvider_Expecter) GetSegmentCompactedNotifyStatus(ctx interface{}, logId interface{}, segmentId interface{}) *MetadataProvider_GetSegmentCompactedNotifyStatus_Call {
	return &MetadataProvider_GetSegmentCompactedNotifyStatus_Call{Call: _e.mock.On("GetSegmentCompactedNotifyStatus", ctx, logId, segmentId)}
}

func (_c *MetadataProvider_GetSegmentCompactedNotifyStatus_Call) Run(run func(ctx context.Context, logId int64, segmentId int64)) *MetadataProvider_GetSegmentCompactedNotifyStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(int64))
	})
	return _c
...
// GetSegmentMetadata provides a mock function with given fields: ctx, logName, segmentId
func (_m *MetadataProvider) GetSegmentMetadata(ctx context.Context, logName string, segmentId int64) (*meta.SegmentMeta, error) {
	ret := _m.Called(ctx, logName, segmentId)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) (*meta.SegmentMeta, error)); ok {
		return rf(ctx, logName, segmentId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) *meta.SegmentMeta); ok {
		r0 = rf(ctx, logName, segmentId)
	} else {
		if ret.Get(0) != nil {
...
//   - logName string
//   - segmentId int64
func (_e *MetadataProvider_Expecter) GetSegmentMetadata(ctx interface{}, logName interface{}, segmentId interface{}) *MetadataProvider_GetSegmentMetadata_Call {
	return &MetadataProvider_GetSegmentMetadata_Call{Call: _e.mock.On("GetSegmentMetadata", ctx, logName, segmentId)}
}

func (_c *MetadataProvider_GetSegmentMetadata_Call) Run(run func(ctx context.Context, logName string, segmentId int64)) *MetadataProvider_GetSegmentMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(int64))
	})
	return _c
...
func (_c *MetadataProvider_GetSegmentMetadata_Call) Return(_a0 *meta.SegmentMeta, _a1 error) *MetadataProvider_GetSegmentMetadata_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MetadataProvider_GetSegmentMetadata_Call) RunAndReturn(run func(context.Context, string, int64) (*meta.SegmentMeta, error)) *MetadataProvider_GetSegmentMetadata_Call {
	_c.Call.Return(run)
	return _c
}

// GetVersionInfo provides a mock function with given fields: ctx
func (_m *MetadataProvider) GetVersionInfo(ctx context.Context) (*proto.Version, error) {
	ret := _m.Called(ctx)
...
//   - ctx context.Context
func (_e *MetadataProvider_Expecter) GetVersionInfo(ctx interface{}) *MetadataProvider_GetVersionInfo_Call {
	return &MetadataProvider_GetVersionInfo_Call{Call: _e.mock.On("GetVersionInfo", ctx)}
}

func (_c *MetadataProvider_GetVersionInfo_Call) Run(run func(ctx context.Context)) *MetadataProvider_GetVersionInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
// ListParkedLogIds provides a mock function with given fields: ctx
func (_m *MetadataProvider) ListParkedLogIds(ctx context.Context) ([]int64, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for ListParkedLogIds")
	}
...
// MetadataProvider_ListParkedLogIds_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListParkedLogIds'
type MetadataProvider_ListParkedLogIds_Call struct {
	*mock.Call
}

// ListParkedLogIds is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MetadataProvider_Expecter) ListParkedLogIds(ctx interface{}) *MetadataProvider_ListParkedLogIds_Call {
	return &MetadataProvider_ListParkedLogIds_Call{Call: _e.mock.On("ListParkedLogIds", ctx)}
}

func (_c *MetadataProvider_ListParkedLogIds_Call) Run(run func(ctx context.Context)) *MetadataProvider_ListParkedLogIds_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MetadataProvider_ListParkedLogIds_Call) Return(_a0 []int64, _a1 error) *MetadataProvider_ListParkedLogIds_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MetadataProvider_ListParkedLogIds_Call) RunAndReturn(run func(context.Context) ([]int64, error)) *MetadataProvider_ListParkedLogIds_Call {
	_c.Call.Return(run)
	return _c
}
...
// ListSegmentCompactedNotifyStatus provides a mock function with given fields: ctx, logId
func (_m *MetadataProvider) ListSegmentCompactedNotifyStatus(ctx context.Context, logId int64) ([]*proto.SegmentCompactedNotifyStatus, error) {
	ret := _m.Called(ctx, logId)

	if len(ret) == 0 {
		panic("no return value specified for ListSegmentCompactedNotifyStatus")
	}

	var r0 []*proto.SegmentCompactedNotifyStatus
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) ([]*proto.SegmentCompactedNotifyStatus, error)); ok {
		return rf(ctx, logId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64) []*proto.SegmentCompactedNotifyStatus); ok {
		r0 = rf(ctx, logId)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*proto.SegmentCompactedNotifyStatus)
...
// MetadataProvider_ListSegmentCompactedNotifyStatus_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListSegmentCompactedNotifyStatus'
type MetadataProvider_ListSegmentCompactedNotifyStatus_Call struct {
	*mock.Call
}

// ListSegmentCompactedNotifyStatus is a helper method to define mock.On call
//   - ctx context.Context
//   - logId int64
func (_e *MetadataProvider_Expecter) ListSegmentCompactedNotifyStatus(ctx interface{}, logId interface{}) *MetadataProvider_ListSegmentCompactedNotifyStatus_Call {
	return &MetadataProvider_ListSegmentCompactedNotifyStatus_Call{Call: _e.mock.On("ListSegmentCompactedNotifyStatus", ctx, logId)}
}

func (_c *MetadataProvider_ListSegmentCompactedNotifyStatus_Call) Run(run func(ctx context.Context, logId int64)) *MetadataProvider_ListSegmentCompactedNotifyStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
func (_c *MetadataProvider_ListSegmentCompactedNotifyStatus_Call) Return(_a0 []*proto.SegmentCompactedNotifyStatus, _a1 error) *MetadataProvider_ListSegmentCompactedNotifyStatus_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MetadataProvider_ListSegmentCompactedNotifyStatus_Call) RunAndReturn(run func(context.Context, int64) ([]*proto.SegmentCompactedNotifyStatus, error)) *MetadataProvider_ListSegmentCompactedNotifyStatus_Call {
	_c.Call.Return(run)
	return _c
}

// OpenLog provides a mock function with given fields: ctx, logName
func (_m *MetadataProvider) OpenLog(ctx context.Context, logName string) (*meta.LogMeta, map[int64]*meta.SegmentMeta, error) {
	ret := _m.Called(ctx, logName)
	...
	var r0 *meta.LogMeta
	var r1 map[int64]*meta.SegmentMeta
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*meta.LogMeta, map[int64]*meta.SegmentMeta, error)); ok {
		return rf(ctx, logName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *meta.LogMeta); ok {
		r0 = rf(ctx, logName)
	...
	if rf, ok := ret.Get(1).(func(context.Context, string) map[int64]*meta.SegmentMeta); ok {
		r1 = rf(ctx, logName)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(map[int64]*meta.SegmentMeta)
		}
	}
...
func (_c *MetadataProvider_OpenLog_Call) Return(_a0 *meta.LogMeta, _a1 map[int64]*meta.SegmentMeta, _a2 error) *MetadataProvider_OpenLog_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MetadataProvider_OpenLog_Call) RunAndReturn(run func(context.Context, string) (*meta.LogMeta, map[int64]*meta.SegmentMeta, error)) *MetadataProvider_OpenLog_Call {
	_c.Call.Return(run)
	return _c
}
...
// StoreSegmentMetadata provides a mock function with given fields: ctx, logName, logId, segmentMeta
func (_m *MetadataProvider) StoreSegmentMetadata(ctx context.Context, logName string, logId int64, segmentMeta *meta.SegmentMeta) error {
	ret := _m.Called(ctx, logName, logId, segmentMeta)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int64, *meta.SegmentMeta) error); ok {
		r0 = rf(ctx, logName, logId, segmentMeta)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MetadataProvider_Expecter) StoreSegmentMetadata(ctx interface{}, logName interface{}, logId interface{}, segmentMeta interface{}) *MetadataProvider_StoreSegmentMetadata_Call {
	return &MetadataProvider_StoreSegmentMetadata_Call{Call: _e.mock.On("StoreSegmentMetadata", ctx, logName, logId, segmentMeta)}
}

func (_c *MetadataProvider_StoreSegmentMetadata_Call) Run(run func(ctx context.Context, logName string, logId int64, segmentMeta *meta.SegmentMeta)) *MetadataProvider_StoreSegmentMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(int64), args[3].(*meta.SegmentMeta))
	})
	return _c
}
...
func (_m *MetadataProvider) UpdateLogMeta(ctx context.Context, logName string, logMeta *meta.LogMeta) error {
...
func (_c *MetadataProvider_UpdateLogMeta_Call) Run(run func(ctx context.Context, logName string, logMeta *meta.LogMeta)) *MetadataProvider_UpdateLogMeta_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*meta.LogMeta))
	})
	return _c
}
...
func (_c *MetadataProvider_UpdateLogMeta_Call) RunAndReturn(run func(context.Context, string, *meta.LogMeta) error) *MetadataProvider_UpdateLogMeta_Call {
	_c.Call.Return(run)
	return _c
}
...
// MetadataProvider_UpdateSegmentCompactedNotifyStatus_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateSegmentCompactedNotifyStatus'
type MetadataProvider_UpdateSegmentCompactedNotifyStatus_Call struct {
	*mock.Call
}
...
func (_c *MetadataProvider_UpdateSegmentCompactedNotifyStatus_Call) Return(_a0 error) *MetadataProvider_UpdateSegmentCompactedNotifyStatus_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// UpdateSegmentMetadata provides a mock function with given fields: ctx, logName, logId, segmentMeta, oldState
func (_m *MetadataProvider) UpdateSegmentMetadata(ctx context.Context, logName string, logId int64, segmentMeta *meta.SegmentMeta, oldState proto.SegmentState) error {
	ret := _m.Called(ctx, logName, logId, segmentMeta, oldState)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int64, *meta.SegmentMeta, proto.SegmentState) error); ok {
		r0 = rf(ctx, logName, logId, segmentMeta, oldState)
	} else {
		r0 = ret.Error(0)
	}
...
//   - segmentMeta *meta.SegmentMeta
//   - oldState proto.SegmentState
func (_e *MetadataProvider_Expecter) UpdateSegmentMetadata(ctx interface{}, logName interface{}, logId interface{}, segmentMeta interface{}, oldState interface{}) *MetadataProvider_UpdateSegmentMetadata_Call {
	return &MetadataProvider_UpdateSegmentMetadata_Call{Call: _e.mock.On("UpdateSegmentMetadata", ctx, logName, logId, segmentMeta, oldState)}
}

func (_c *MetadataProvider_UpdateSegmentMetadata_Call) Run(run func(ctx context.Context, logName string, logId int64, segmentMeta *meta.SegmentMeta, oldState proto.SegmentState)) *MetadataProvider_UpdateSegmentMetadata_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(int64), args[3].(*meta.SegmentMeta), args[4].(proto.SegmentState))
	})
	return _c
}
...
func (_c *MetadataProvider_UpdateSegmentMetadata_Call) RunAndReturn(run func(context.Context, string, int64, *meta.SegmentMeta, proto.SegmentState) error) *MetadataProvider_UpdateSegmentMetadata_Call {
	_c.Call.Return(run)
	return _c
}
