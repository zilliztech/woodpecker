...
func (_m *LogStore) AddEntry(_a0 context.Context, _a1 int64, _a2 *segment.SegmentEntry) (int64, <-chan int64, error) {
...
//   - _a0 context.Context
//   - _a1 int64
//   - _a2 *segment.SegmentEntry
func (_e *LogStore_Expecter) AddEntry(_a0 interface{}, _a1 interface{}, _a2 interface{}) *LogStore_AddEntry_Call {
	return &LogStore_AddEntry_Call{Call: _e.mock.On("AddEntry", _a0, _a1, _a2)}
}

func (_c *LogStore_AddEntry_Call) Run(run func(_a0 context.Context, _a1 int64, _a2 *segment.SegmentEntry)) *LogStore_AddEntry_Call {
...
func (_c *LogStore_AddEntry_Call) Return(_a0 int64, _a1 <-chan int64, _a2 error) *LogStore_AddEntry_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *LogStore_AddEntry_Call) RunAndReturn(run func(context.Context, int64, *segment.SegmentEntry) (int64, <-chan int64, error)) *LogStore_AddEntry_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogStore) GetEntry(_a0 context.Context, _a1 int64, _a2 int64, _a3 int64) (*segment.SegmentEntry, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3)
...
func (_c *LogStore_GetEntry_Call) Return(_a0 *segment.SegmentEntry, _a1 error) *LogStore_GetEntry_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogStore_GetEntry_Call) RunAndReturn(run func(context.Context, int64, int64, int64) (*segment.SegmentEntry, error)) *LogStore_GetEntry_Call {
	_c.Call.Return(run)
	return _c
}
...
// RecoverySegmentFromInRecovery provides a mock function with given fields: _a0, _a1, _a2
func (_m *LogStore) RecoverySegmentFromInRecovery(_a0 context.Context, _a1 int64, _a2 int64) (*proto.SegmentMetadata, error) {
	ret := _m.Called(_a0, _a1, _a2)

	if len(ret) == 0 {
		panic("no return value specified for RecoverySegmentFromInRecovery")
	}
...
// LogStore_RecoverySegmentFromInRecovery_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RecoverySegmentFromInRecovery'
type LogStore_RecoverySegmentFromInRecovery_Call struct {
	*mock.Call
}

// RecoverySegmentFromInRecovery is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 int64
//   - _a2 int64
func (_e *LogStore_Expecter) RecoverySegmentFromInRecovery(_a0 interface{}, _a1 interface{}, _a2 interface{}) *LogStore_RecoverySegmentFromInRecovery_Call {
	return &LogStore_RecoverySegmentFromInRecovery_Call{Call: _e.mock.On("RecoverySegmentFromInRecovery", _a0, _a1, _a2)}
}

func (_c *LogStore_RecoverySegmentFromInRecovery_Call) Run(run func(_a0 context.Context, _a1 int64, _a2 int64)) *LogStore_RecoverySegmentFromInRecovery_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(int64))
	})
	return _c
...
func (_c *LogStore_RecoverySegmentFromInRecovery_Call) Return(_a0 *proto.SegmentMetadata, _a1 error) *LogStore_RecoverySegmentFromInRecovery_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogStore_RecoverySegmentFromInRecovery_Call) RunAndReturn(run func(context.Context, int64, int64) (*proto.SegmentMetadata, error)) *LogStore_RecoverySegmentFromInRecovery_Call {
	_c.Call.Return(run)
	return _c
}
