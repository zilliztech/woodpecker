...
// GetWriterSnapshot provides a mock function with no fields
func (_m *SegmentProcessor) GetWriterSnapshot() *storage.WriterSnapshot {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetWriterSnapshot")
	}
...
// SegmentProcessor_GetWriterSnapshot_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetWriterSnapshot'
type SegmentProcessor_GetWriterSnapshot_Call struct {
	*mock.Call
}

// GetWriterSnapshot is a helper method to define mock.On call
func (_e *SegmentProcessor_Expecter) GetWriterSnapshot() *SegmentProcessor_GetWriterSnapshot_Call {
	return &SegmentProcessor_GetWriterSnapshot_Call{Call: _e.mock.On("GetWriterSnapshot")}
}

func (_c *SegmentProcessor_GetWriterSnapshot_Call) Run(run func()) *SegmentProcessor_GetWriterSnapshot_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *SegmentProcessor_GetWriterSnapshot_Call) Return(_a0 *storage.WriterSnapshot) *SegmentProcessor_GetWriterSnapshot_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SegmentProcessor_GetWriterSnapshot_Call) RunAndReturn(run func() *storage.WriterSnapshot) *SegmentProcessor_GetWriterSnapshot_Call {
	_c.Call.Return(run)
	return _c
}

// GetWriterSnapshotDetailed provides a mock function with no fields
func (_m *SegmentProcessor) GetWriterSnapshotDetailed() *storage.WriterSnapshotDetailed {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetWriterSnapshotDetailed")
	}
...
// SegmentProcessor_GetWriterSnapshotDetailed_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetWriterSnapshotDetailed'
type SegmentProcessor_GetWriterSnapshotDetailed_Call struct {
	*mock.Call
}

// GetWriterSnapshotDetailed is a helper method to define mock.On call
func (_e *SegmentProcessor_Expecter) GetWriterSnapshotDetailed() *SegmentProcessor_GetWriterSnapshotDetailed_Call {
	return &SegmentProcessor_GetWriterSnapshotDetailed_Call{Call: _e.mock.On("GetWriterSnapshotDetailed")}
}

func (_c *SegmentProcessor_GetWriterSnapshotDetailed_Call) Run(run func()) *SegmentProcessor_GetWriterSnapshotDetailed_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *SegmentProcessor_GetWriterSnapshotDetailed_Call) Return(_a0 *storage.WriterSnapshotDetailed) *SegmentProcessor_GetWriterSnapshotDetailed_Call {
	_c.Call.Return(_a0)
	return _c
}
