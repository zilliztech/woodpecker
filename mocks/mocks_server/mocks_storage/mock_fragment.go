...
// AppendToMergeTarget provides a mock function with given fields: ctx, mergeTarget, baseOffset
func (_m *Fragment) AppendToMergeTarget(ctx context.Context, mergeTarget storage.Fragment, baseOffset int64) error {
	ret := _m.Called(ctx, mergeTarget, baseOffset)

	if len(ret) == 0 {
		panic("no return value specified for AppendToMergeTarget")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, storage.Fragment, int64) error); ok {
		r0 = rf(ctx, mergeTarget, baseOffset)
	} else {
		r0 = ret.Error(0)
	}
...
// Fragment_AppendToMergeTarget_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AppendToMergeTarget'
type Fragment_AppendToMergeTarget_Call struct {
	*mock.Call
}

// AppendToMergeTarget is a helper method to define mock.On call
//   - ctx context.Context
//   - mergeTarget storage.Fragment
//   - baseOffset int64
func (_e *Fragment_Expecter) AppendToMergeTarget(ctx interface{}, mergeTarget interface{}, baseOffset interface{}) *Fragment_AppendToMergeTarget_Call {
	return &Fragment_AppendToMergeTarget_Call{Call: _e.mock.On("AppendToMergeTarget", ctx, mergeTarget, baseOffset)}
}

func (_c *Fragment_AppendToMergeTarget_Call) Run(run func(ctx context.Context, mergeTarget storage.Fragment, baseOffset int64)) *Fragment_AppendToMergeTarget_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(storage.Fragment), args[2].(int64))
	})
	return _c
}

func (_c *Fragment_AppendToMergeTarget_Call) Return(_a0 error) *Fragment_AppendToMergeTarget_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Fragment_AppendToMergeTarget_Call) RunAndReturn(run func(context.Context, storage.Fragment, int64) error) *Fragment_AppendToMergeTarget_Call {
	_c.Call.Return(run)
	return _c
}
...
// LoadSizeStateOnly provides a mock function with given fields: ctx
func (_m *Fragment) LoadSizeStateOnly(ctx context.Context) (int64, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for LoadSizeStateOnly")
	}
...
// Fragment_LoadSizeStateOnly_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LoadSizeStateOnly'
type Fragment_LoadSizeStateOnly_Call struct {
	*mock.Call
}

// LoadSizeStateOnly is a helper method to define mock.On call
//   - ctx context.Context
func (_e *Fragment_Expecter) LoadSizeStateOnly(ctx interface{}) *Fragment_LoadSizeStateOnly_Call {
	return &Fragment_LoadSizeStateOnly_Call{Call: _e.mock.On("LoadSizeStateOnly", ctx)}
}

func (_c *Fragment_LoadSizeStateOnly_Call) Run(run func(ctx context.Context)) *Fragment_LoadSizeStateOnly_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *Fragment_LoadSizeStateOnly_Call) Return(_a0 int64, _a1 error) *Fragment_LoadSizeStateOnly_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Fragment_LoadSizeStateOnly_Call) RunAndReturn(run func(context.Context) (int64, error)) *Fragment_LoadSizeStateOnly_Call {
	_c.Call.Return(run)
	return _c
}
