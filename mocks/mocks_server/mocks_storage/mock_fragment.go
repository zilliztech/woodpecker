...
// Fragment_Delete_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Delete'
type Fragment_Delete_Call struct {
	*mock.Call
}

// Delete is a helper method to define mock.On call
func (_e *Fragment_Expecter) Delete() *Fragment_Delete_Call {
	return &Fragment_Delete_Call{Call: _e.mock.On("Delete")}
}

func (_c *Fragment_Delete_Call) Run(run func()) *Fragment_Delete_Call {
...
func (_c *Fragment_Delete_Call) Return(_a0 error) *Fragment_Delete_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Fragment_Delete_Call) RunAndReturn(run func() error) *Fragment_Delete_Call {
	_c.Call.Return(run)
	return _c
}
