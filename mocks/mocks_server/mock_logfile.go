...
// LastOffset provides a mock function with given fields:
func (_m *LogFile) LastOffset() uint64 {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for LastOffset")
	}
...
// LogFile_LastOffset_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LastOffset'
type LogFile_LastOffset_Call struct {
	*mock.Call
}

// LastOffset is a helper method to define mock.On call
func (_e *LogFile_Expecter) LastOffset() *LogFile_LastOffset_Call {
	return &LogFile_LastOffset_Call{Call: _e.mock.On("LastOffset")}
}

func (_c *LogFile_LastOffset_Call) Run(run func()) *LogFile_LastOffset_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *LogFile_LastOffset_Call) Return(_a0 uint64) *LogFile_LastOffset_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *LogFile_LastOffset_Call) RunAndReturn(run func() uint64) *LogFile_LastOffset_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogFile) Merge(ctx context.Context) ([]storage.Fragment, []int32, error) {
	ret := _m.Called(ctx)
	...
	var r1 []int32
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]storage.Fragment, []int32, error)); ok {
		return rf(ctx)
	}
...
func (_c *LogFile_Merge_Call) Return(_a0 []storage.Fragment, _a1 []int32, _a2 error) *LogFile_Merge_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *LogFile_Merge_Call) RunAndReturn(run func(context.Context) ([]storage.Fragment, []int32, error)) *LogFile_Merge_Call {
	_c.Call.Return(run)
	return _c
}
