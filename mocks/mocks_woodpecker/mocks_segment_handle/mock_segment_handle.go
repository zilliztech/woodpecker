...
// PendingAppendStats provides a mock function with no fields
func (_m *SegmentHandle) PendingAppendStats() (int, time.Duration, int64, int64) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for PendingAppendStats")
	}
	...
	var r2 int64
	var r3 int64
	if rf, ok := ret.Get(0).(func() (int, time.Duration, int64, int64)); ok {
		return rf()
	}
...
// SegmentHandle_PendingAppendStats_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PendingAppendStats'
type SegmentHandle_PendingAppendStats_Call struct {
	*mock.Call
}

// PendingAppendStats is a helper method to define mock.On call
func (_e *SegmentHandle_Expecter) PendingAppendStats() *SegmentHandle_PendingAppendStats_Call {
	return &SegmentHandle_PendingAppendStats_Call{Call: _e.mock.On("PendingAppendStats")}
}

func (_c *SegmentHandle_PendingAppendStats_Call) Run(run func()) *SegmentHandle_PendingAppendStats_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *SegmentHandle_PendingAppendStats_Call) Return(pending int, oldestPendingAge time.Duration, lastPushed int64, lastAddConfirmed int64) *SegmentHandle_PendingAppendStats_Call {
	_c.Call.Return(pending, oldestPendingAge, lastPushed, lastAddConfirmed)
	return _c
}

func (_c *SegmentHandle_PendingAppendStats_Call) RunAndReturn(run func() (int, time.Duration, int64, int64)) *SegmentHandle_PendingAppendStats_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *SegmentHandle) SetRollingReady(ctx context.Context) error {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for SetRollingReady")
	}
...
func (_c *SegmentHandle_SetRollingReady_Call) Return(_a0 error) *SegmentHandle_SetRollingReady_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SegmentHandle_SetRollingReady_Call) RunAndReturn(run func(context.Context) error) *SegmentHandle_SetRollingReady_Call {
	_c.Call.Return(run)
	return _c
}
