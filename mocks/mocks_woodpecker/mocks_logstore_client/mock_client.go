...
func (_m *LogStoreClient) MarkLogDeleted(ctx context.Context, bucketName string, rootPath string, logId int64, sync bool) (bool, error) {
...
func (_c *LogStoreClient_MarkLogDeleted_Call) Return(_a0 bool, _a1 error) *LogStoreClient_MarkLogDeleted_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogStoreClient_MarkLogDeleted_Call) RunAndReturn(run func(context.Context, string, string, int64, bool) (bool, error)) *LogStoreClient_MarkLogDeleted_Call {
	_c.Call.Return(run)
	return _c
}
...
// SegmentCompact provides a mock function with given fields: ctx, bucketName, rootPath, logId, segmentId, expectedLastEntryId
func (_m *LogStoreClient) SegmentCompact(ctx context.Context, bucketName string, rootPath string, logId int64, segmentId int64, expectedLastEntryId int64) (*proto.SegmentMetadata, error) {
...
func (_e *LogStoreClient_Expecter) SegmentCompact(ctx interface{}, bucketName interface{}, rootPath interface{}, logId interface{}, segmentId interface{}, expectedLastEntryId interface{}) *LogStoreClient_SegmentCompact_Call {
	return &LogStoreClient_SegmentCompact_Call{Call: _e.mock.On("SegmentCompact", ctx, bucketName, rootPath, logId, segmentId, expectedLastEntryId)}
}

func (_c *LogStoreClient_SegmentCompact_Call) Run(run func(ctx context.Context, bucketName string, rootPath string, logId int64, segmentId int64, expectedLastEntryId int64)) *LogStoreClient_SegmentCompact_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(int64), args[4].(int64), args[5].(int64))
	})
	return _c
...
func (_c *LogStoreClient_SegmentCompact_Call) RunAndReturn(run func(context.Context, string, string, int64, int64, int64) (*proto.SegmentMetadata, error)) *LogStoreClient_SegmentCompact_Call {
	_c.Call.Return(run)
	return _c
}
