...
func (_m *LogReader) Close(ctx context.Context) error {
	ret := _m.Called(ctx)
...
//   - ctx context.Context
func (_e *LogReader_Expecter) Close(ctx interface{}) *LogReader_Close_Call {
	return &LogReader_Close_Call{Call: _e.mock.On("Close", ctx)}
}

func (_c *LogReader_Close_Call) Run(run func(ctx context.Context)) *LogReader_Close_Call {
...
// ReadNext provides a mock function with given fields: ctx
func (_m *LogReader) ReadNext(ctx context.Context) (*log.LogMessage, error) {
	ret := _m.Called(ctx)
...
//   - ctx context.Context
func (_e *LogReader_Expecter) ReadNext(ctx interface{}) *LogReader_ReadNext_Call {
	return &LogReader_ReadNext_Call{Call: _e.mock.On("ReadNext", ctx)}
}

func (_c *LogReader_ReadNext_Call) Run(run func(ctx context.Context)) *LogReader_ReadNext_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
