...
// RollWritableSegmentIfDue provides a mock function with given fields: ctx, writerInvalidationNotifier
func (_m *LogHandle) RollWritableSegmentIfDue(ctx context.Context, writerInvalidationNotifier func(context.Context, string)) error {
	ret := _m.Called(ctx, writerInvalidationNotifier)

	if len(ret) == 0 {
		panic("no return value specified for RollWritableSegmentIfDue")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, func(context.Context, string)) error); ok {
		r0 = rf(ctx, writerInvalidationNotifier)
	} else {
		r0 = ret.Error(0)
	}
...
// LogHandle_RollWritableSegmentIfDue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RollWritableSegmentIfDue'
type LogHandle_RollWritableSegmentIfDue_Call struct {
	*mock.Call
}

// RollWritableSegmentIfDue is a helper method to define mock.On call
//   - ctx context.Context
//   - writerInvalidationNotifier func(context.Context , string)
func (_e *LogHandle_Expecter) RollWritableSegmentIfDue(ctx interface{}, writerInvalidationNotifier interface{}) *LogHandle_RollWritableSegmentIfDue_Call {
	return &LogHandle_RollWritableSegmentIfDue_Call{Call: _e.mock.On("RollWritableSegmentIfDue", ctx, writerInvalidationNotifier)}
}

func (_c *LogHandle_RollWritableSegmentIfDue_Call) Run(run func(ctx context.Context, writerInvalidationNotifier func(context.Context, string))) *LogHandle_RollWritableSegmentIfDue_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(func(context.Context, string)))
	})
	return _c
...
func (_c *LogHandle_RollWritableSegmentIfDue_Call) Return(_a0 error) *LogHandle_RollWritableSegmentIfDue_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *LogHandle_RollWritableSegmentIfDue_Call) RunAndReturn(run func(context.Context, func(context.Context, string)) error) *LogHandle_RollWritableSegmentIfDue_Call {
	_c.Call.Return(run)
	return _c
}
