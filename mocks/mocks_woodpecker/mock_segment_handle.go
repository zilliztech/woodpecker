...
import (
	...
	serversegment "github.com/zilliztech/woodpecker/server/segment"
)
...
// GetLogName provides a mock function with given fields:
...
func (_m *SegmentHandle) Read(_a0 context.Context, _a1 int64, _a2 int64) ([]*serversegment.SegmentEntry, error) {
	...
	var r0 []*serversegment.SegmentEntry
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64) ([]*serversegment.SegmentEntry, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64) []*serversegment.SegmentEntry); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*serversegment.SegmentEntry)
		}
	}
...
func (_c *SegmentHandle_Read_Call) Return(_a0 []*serversegment.SegmentEntry, _a1 error) *SegmentHandle_Read_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SegmentHandle_Read_Call) RunAndReturn(run func(context.Context, int64, int64) ([]*serversegment.SegmentEntry, error)) *SegmentHandle_Read_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *SegmentHandle) RefreshAndGetMetadata(_a0 context.Context) *proto.SegmentMetadata {
	ret := _m.Called(_a0)
...
func (_c *SegmentHandle_RefreshAndGetMetadata_Call) Return(_a0 *proto.SegmentMetadata) *SegmentHandle_RefreshAndGetMetadata_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SegmentHandle_RefreshAndGetMetadata_Call) RunAndReturn(run func(context.Context) *proto.SegmentMetadata) *SegmentHandle_RefreshAndGetMetadata_Call {
	_c.Call.Return(run)
	return _c
}
