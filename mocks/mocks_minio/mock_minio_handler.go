...
func (_m *MinioHandler) GetObjectDataAndInfo(ctx context.Context, bucketName string, objectName string, opts minio.GetObjectOptions) (io.Reader, int64, error) {
	ret := _m.Called(ctx, bucketName, objectName, opts)
	...
	var r1 int64
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, minio.GetObjectOptions) (io.Reader, int64, error)); ok {
		return rf(ctx, bucketName, objectName, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, minio.GetObjectOptions) io.Reader); ok {
		r0 = rf(ctx, bucketName, objectName, opts)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MinioHandler_GetObjectDataAndInfo_Call) Return(_a0 io.Reader, _a1 int64, _a2 error) *MinioHandler_GetObjectDataAndInfo_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MinioHandler_GetObjectDataAndInfo_Call) RunAndReturn(run func(context.Context, string, string, minio.GetObjectOptions) (io.Reader, int64, error)) *MinioHandler_GetObjectDataAndInfo_Call {
	_c.Call.Return(run)
	return _c
}
